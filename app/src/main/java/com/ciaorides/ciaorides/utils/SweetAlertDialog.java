...
import static cn.pedant.SweetAlert.Constants.FOCUS_TOUCH_LISTENER;
...
public class SweetAlertDialog  extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCustomViewContainer = (FrameLayout) findViewById(cn.pedant.SweetAlert.R.id.custom_view_container);
        ...
        mConfirmButton.setOnTouchListener(FOCUS_TOUCH_LISTENER);
        mCancelButton = (Button) findViewById(cn.pedant.SweetAlert.R.id.cancel_button);
        mCancelButton.setOnClickListener(this);
        mCancelButton.setOnTouchListener(FOCUS_TOUCH_LISTENER);
        mNeutralButton = (Button) findViewById(cn.pedant.SweetAlert.R.id.neutral_button);
        mNeutralButton.setOnClickListener(this);
        mNeutralButton.setOnTouchListener(FOCUS_TOUCH_LISTENER);
        ...
        if (mDialogView != null) {
            ...
            switch (mAlertType) {
                case ERROR_TYPE:
                    ...
                    mTitleTextView.setTextColor(Color.parseColor("#E00000"));
                    break;
                case SUCCESS_TYPE:
                    mSuccessFrame.setVisibility(View.VISIBLE);
                    // initial rotate layout of success mask
                    mTitleTextView.setTextColor(Color.parseColor("#06C22B"));
...
//                    mConfirmButton.setBackgroundResource(R.drawable.red_button_background);
    ...
    public SweetAlertDialog setContentText(String text) {
        ...
        if (mContentTextView != null && mContentText != null) {
            ...
            mContentTextView.setTextSize(15);
