    ...
    fun showInfoDialog(
        ...
        with(infoBinding) {
            car?.let {
                ...
                txtCommision.text = "Rs " + car.ride_charges.toString()
                txtCancelCharge.text = "Rs 0"
                txtPerHead.text = "Rs " + car.convenience_charges.toString()
            ...
            bike?.let { bike ->
                ...
                txtCommision.text = "Rs " + bike.ride_charges.toString()
                txtCancelCharge.text = "Rs 0"
                txtPerHead.text = "Rs " + bike.convenience_charges.toString()
            ...
            auto?.let { auto ->
                ...
                txtCommision.text = "Rs " + auto.ride_charges.toString()
                txtCancelCharge.text = "Rs 0"
                txtPerHead.text = "Rs " + auto.convenience_charges.toString()
