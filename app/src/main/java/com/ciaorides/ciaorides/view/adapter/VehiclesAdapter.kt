...
class VehiclesAdapter @Inject constructor() :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.apply {
            tvVehicle.text = vehicle.sub_vehicle_type
            tvMaxSize.text = vehicle.max_seat_capacity
            tvPrice.text = Constants.getPrice(vehicle.total_amount)
        }
        ...
        holder.binding.cardSelected.setOnClickListener {
