...
import com.ciaorides.ciaorides.databinding.ItemPendingPaymentsBinding
...
class PendingPaymentAdapter @Inject constructor(private val listener : OnItemClickListener) :
    ...
    inner class ViewHolder(val binding: ItemPendingPaymentsBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            ItemPendingPaymentsBinding.inflate(LayoutInflater.from(parent.context), parent, false)
