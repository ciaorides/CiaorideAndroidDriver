...
class MyVehiclesInSearchAdapter @Inject constructor() :
    RecyclerView.Adapter<MyVehiclesInSearchAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.apply {
            tvVehicle.text = vehicle.vehicle_makes[0].title
            tvPrice.text = vehicle.vehicle_type
            ivMaxCap.visibility = View.GONE
        }
    ...
    private var setInfoClickCallBack: ((user: MyVehicleResponse.Response) -> Unit)? =
        null

    fun infoClickCallBack(listener: (MyVehicleResponse.Response) -> Unit) {
