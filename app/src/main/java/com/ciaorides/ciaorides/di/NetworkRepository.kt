...
//                        ImageUploadResponse::class.java)
    ...
    suspend fun getPayments(request: GlobalUserIdRequest): Response<PaymentsResponse> {
        return usersDataApi.getMyPayments(request)
    }

    suspend fun getPendingPayments(request: GlobalUserIdRequest) : Response<PaymentsResponse>{
        return usersDataApi.getMyPendingPayments(request)
    }
    ...
    suspend fun postWithdrawTransactions(request: WithdrawTransactionRequest) : Response<GlobalResponse>{
        return usersDataApi.withdrawTransaction(request)
    }

    suspend fun postAddTransactions(request: AddTransactionRequest) : Response<GlobalResponse>{
        return usersDataApi.addTransaction(request)
    }

    suspend fun getTransactions(request: GetTransactionRequest) : Response<GetTransactionResposne>{
    ...
    suspend fun pickUpTaxiRide(request: PickUpRideRequest): Response<GlobalResponse>? {
        return try {
            usersDataApi.pickupTaxiRide(request)
        } catch (e: Exception) {
            e.printStackTrace()
            null
        }
