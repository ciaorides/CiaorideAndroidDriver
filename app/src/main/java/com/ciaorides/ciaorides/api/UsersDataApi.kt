...
interface UsersDataApi {
    ...
    @POST("driver1/driver_cancel_order")
...
//    suspend fun uploadImage(@Part files:List<MultipartBody.Part>): Response<ImageUploadResponse>
    ...
    @POST("menuitems/my_payments")
    suspend fun getMyPayments(@Body request: GlobalUserIdRequest): Response<PaymentsResponse>

    @POST("menuitems/pending_payments")
    suspend fun getMyPendingPayments(@Body request: GlobalUserIdRequest): Response<PaymentsResponse>

    @POST("taxi_flow/update_profile")
    suspend fun updateProfile(@Body request: UpdateProfileRequest): Response<UserDetailsResponse>

    @POST("driver1/withdraw_transaction")
    suspend fun withdrawTransaction(@Body request: WithdrawTransactionRequest): Response<GlobalResponse>

    @POST("driver1/add_transaction")
    suspend fun addTransaction(@Body request: AddTransactionRequest): Response<GlobalResponse>

    @POST("driver1/get_transactions")
